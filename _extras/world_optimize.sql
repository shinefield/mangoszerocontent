...
-- is properly sorted in a human-readable order in the database for
-- easier browsing.
--
...
ALTER TABLE `creature_movement_template`        ORDER BY `entry` ASC, `point` ASC;
...
ALTER TABLE `gossip_menu`                       ORDER BY `entry` ASC, `text_id` ASC;
ALTER TABLE `gossip_menu_option`                ORDER BY `menu_id` ASC, `id` ASC;
...
ALTER TABLE `locales_gossip_menu_option`        ORDER BY `menu_id` ASC, `id` ASC;
ALTER TABLE `locales_item`                      ORDER BY `entry` ASC;
ALTER TABLE `locales_npc_text`                  ORDER BY `entry` ASC;
ALTER TABLE `locales_page_text`                 ORDER BY `entry` ASC;
ALTER TABLE `locales_points_of_interest`        ORDER BY `entry` ASC;
ALTER TABLE `locales_quest`                     ORDER BY `entry` ASC;
