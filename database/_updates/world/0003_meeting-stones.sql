...
UPDATE `db_version`
SET
    `version`             = 'mangos-zero - version 0.1.3 (dev-0003)',
    `creature_ai_version` = 'mangos-zero Artificial Creature Intelligence - version 0.1.3 (dev-0003)'
WHERE
    `version`             = 'mangos-zero - version 0.1.2 (dev-0002)'
;
...
VALUES
     (101,       178824,     1,     -4374.19,     -1953.61,      89.6649,       2.71399)
    ,(102,       178825,     1,     -4465.69,     -1807.09,      86.6898,      -3.00197)
    ,(103,       178826,     1,      -4427.5,      1412.92,      132.459,      -2.60054)
    ,(104,       178827,     1,     -1417.55,      2817.21,      112.341,       2.93215)
    ,(105,       178828,     1,      4075.15,      814.207,        2.121,        1.5708)
    ,(106,       178829,     1,     -6829.23,     -2874.29,      9.19099,      -1.18682)
    ,(107,       178831,     0,      3372.45,     -3379.63,      144.855,       3.03687)
    ,(108,       178832,     0,      1232.23,     -2571.76,      90.4589,      -1.71042)
    ,(109,       178833,     0,     -6116.46,     -3299.53,      257.655,       2.87107)
    ,(110,       178834,     0,     -11089.3,      1561.09,      49.4401,       2.31256)
    ,(111,       178844,     0,      2655.95,     -678.247,      111.193,      0.427606)
    ,(112,       178845,     0,     -247.137,      1509.01,      75.8482,      -2.68781)
    ,(113,       178884,     1,     -793.299,     -2135.61,      92.3452,       2.98451)
    ,(114,       179554,     0,     -10457.8,     -3807.79,      18.0667,       1.98095)
    ,(115,       179555,     0,      -5203.7,        606.7,      411.465,        1.9984)
    ,(116,       179584,     0,     -7590.69,     -1139.77,      260.681,      -2.76635)
    ,(117,       179585,     0,     -7625.35,     -1226.51,      231.776,      -2.77262)
--  ,(118,       179586,     0,            0,            0,            0,             0)
--  ,(119,       179587,     0,            0,            0,            0,             0)
    ,(120,       179595,     0,      -8810.5,      798.038,      98.1829,       -3.0456)
    ,(121,       179596,     1,       1818.3,     -4402.07,     -17.8275,       2.68781)
    ,(122,       185321,     1,     -4753.15,     -3652.78,      46.3757,       -2.3911)
    ,(123,       185433,     0,     -11888.1,     -873.104,      35.8599,       2.05076)
;
...
WHERE
    `guid` IN (
        101, 102, 103, 104, 105, 106, 107, 108, 109, 110, 111, 112, 113, 114, 115, 116, 117, 120, 121, 122, 123
    )
;
