...
VALUES
    ('mangos-zero - version 0.1.2 (dev-0002)',
     'mangos-zero Artificial Creature Intelligence - version 0.1.2 (dev-0002)',
     NULL)
;
...
VALUES
    ...
    ,(15313,   15374,      'Moonkin Form',                  'Night Elf Druid')
    ,(15314,   15375,      'Moonkin Form',                  'Tauren Druid')
;
