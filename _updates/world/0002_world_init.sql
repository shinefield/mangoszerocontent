...
SET
    ...
    `minhealth`          = 9999,    `maxhealth`       = 9999,
    `attackpower`        = 3,       `baseattacktime`  = 2000,
    `mindmg`             = 7,       `maxdmg`          = 7,
    `minrangedmg`        = 1.76,    `maxrangedmg`     = 2.42,
    `rangedattackpower`  = 100,     `rangeattacktime` = 2200,
    `speed_walk`         = 0.91,
...
SET
    ...
    `minlevel`           = 63,      `maxlevel`        = 63,
    `minhealth`          = 9999,    `maxhealth`       = 9999,
    `attackpower`        = 5,       `baseattacktime`  = 1800,
    `mindmg`             = 11,      `maxdmg`          = 11,
    `minrangedmg`        = 387.6,   `maxrangedmg`     = 532.95,
    `rangedattackpower`  = 100,     `rangeattacktime` = 1900,
    `speed_walk`         = 0,
    `flags_extra`        = @CREATURE_FLAG_EXTRA_CIVILIAN | @CREATURE_FLAG_EXTRA_INVISIBLE,
    `type`               = @CREATURE_TYPE_CRITTER
WHERE `entry` = 2;
...
UPDATE `creature_template`
SET
    `faction_A`         = 90,       `faction_H`       = 90,
    `minlevel`          = 50,       `maxlevel`        = 50,
    `minhealth`         = 3517,     `maxhealth`       = 3517,
    `minmana`           = 3460,     `maxmana`         = 3460,
    `attackpower`       = 93,       `baseattacktime`  = 1510,
    `mindmg`            = 183,      `maxdmg`          = 220,
    `minrangedmg`       = 66.44,    `maxrangedmg`     = 91.355,
    `rangedattackpower` = 100,      `rangeattacktime` = 1661,
    `speed_walk`        = 1.4,
...
SET
    ...
    `minhealth`         = 166,      `maxhealth`       = 166,
    `minmana`           = 85,       `maxmana`         = 85,
    `attackpower`       = 3,        `baseattacktime`  = 2000,
    `mindmg`            = 6,        `maxdmg`          = 8,
    `minrangedmg`       = 8.624,    `maxrangedmg`     = 11.858,
...
SET
    ...
    `minhealth`         = 3857,     `maxhealth`       = 3857,
    `minmana`           = 1666,     `maxmana`         = 3195,
    `attackpower`       = 58,       `baseattacktime`  = 2000,
    `mindmg`            = 110,      `maxdmg`          = 142,
    `minrangedmg`       = 74.448,   `maxrangedmg`     = 102.366,
    `rangedattackpower` = 100,
...
SET
    ...
    `minhealth`         = 1528,     `maxhealth`       = 1528,
    `minmana`           = 1126,     `maxmana`         = 1126,
    `attackpower`       = 4,        `baseattacktime`  = 1720,
    `mindmg`            = 9,        `maxdmg`          = 10,
    `minrangedmg`       = 43.8944,  `maxrangedmg`     = 60.3548,
    `rangedattackpower` = 100,      `rangeattacktime` = 1892,
...
SET
    ...
    `minhealth`         = 548,      `maxhealth`       = 548,
    `minmana`           = 300,      `maxmana`         = 300,
    `attackpower`       = 8,        `baseattacktime`  = 2000,
    `mindmg`            = 15,       `maxdmg`          = 19,
    `minrangedmg`       = 23.0384,  `maxrangedmg`     = 31.6778,
    `rangedattackpower` = 100,
    `speed_walk`        = 1.1,
    `InhabitType`       = @CREATURE_INHABIT_GROUND,
    `type`              = @CREATURE_TYPE_DEMON
...
SET
    ...
    `minhealth`         = 919,      `maxhealth`       = 919,
    `minmana`           = 436,      `maxmana`         = 436,
    `attackpower`       = 13,       `baseattacktime`  = 2000,
    `mindmg`            = 24,       `maxdmg`          = 31,
    `minrangedmg`       = 31.856,   `maxrangedmg`     = 43.802,
    `rangedattackpower` = 100,
    `speed_walk`        = 1.1,
    `InhabitType`       = @CREATURE_INHABIT_GROUND,
    `type`              = @CREATURE_TYPE_DEMON
...
SET
    ...
    `minhealth`         = 5000,     `maxhealth`       = 5000,
    `attackpower`       = 24,       `baseattacktime`  = 2000,
    `mindmg`            = 2,        `maxdmg`          = 2,
    `minrangedmg`       = 1,        `maxrangedmg`     = 1,
    `speed_walk`        = 1.2,
...
SET
    ...
    `minhealth`         = 1042,     `maxhealth`       = 1042,
    `attackpower`       = 22,       `baseattacktime`  = 1790,
    `mindmg`            = 44,       `maxdmg`          = 52,
    `minrangedmg`       = 34.6544,  `maxrangedmg`     = 47.6498,
    `rangedattackpower` = 100,      `rangeattacktime` = 1969,
    `speed_walk`        = 1.03,
    `InhabitType`       = @CREATURE_INHABIT_GROUND,
    `flags_extra`       = @CREATURE_FLAG_EXTRA_CIVILIAN,
    `type`              = @CREATURE_TYPE_DEMON
...
SET
    ...
    `minlevel`          = 63,       `maxlevel`        = 63,
    `minhealth`         = 8832,     `maxhealth`       = 8832,
    `attackpower`       = 265,      `baseattacktime`  = 1020,
    `mindmg`            = 520,      `maxdmg`          = 628,
    `minrangedmg`       = 88.8624,  `maxrangedmg`     = 122.186,
    `rangedattackpower` = 100,      `rangeattacktime` = 1122,
    `scale`             = 2.25,
    `speed_walk`        = 1.3,
    `unit_class`        = @CREATURE_CLASS_WARRIOR,
...
SET
    `faction_A`         = 35,       `faction_H`       = 35,
    `minlevel`          = 60,       `maxlevel`        = 60,
    `minhealth`         = 7680,     `maxhealth`       = 7680,
    `attackpower`       = 87,       `baseattacktime`  = 2000,
    `mindmg`            = 164,      `maxdmg`          = 212,
    `minrangedmg`       = 74.448,   `maxrangedmg`     = 102.366,
    `rangedattackpower` = 100,
    `speed_run`         = 1,
    `InhabitType`       = @CREATURE_INHABIT_GROUND,
...
SET
    `faction_A`         = 35,       `faction_H`       = 35,
    `minlevel`          = 1,        `maxlevel`        = 1,
    `minhealth`         = 8,        `maxhealth`       = 8,
    `attackpower`       = 1,        `baseattacktime`  = 0,
    `mindmg`            = 2,        `maxdmg`          = 2,
    `minrangedmg`       = 0,        `maxrangedmg`     = 0,
    `flags_extra`       = @CREATURE_FLAG_EXTRA_CIVILIAN,
    `type`              = @CREATURE_TYPE_CRITTER
WHERE `entry` = 12861;
